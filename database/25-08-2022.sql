...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2022 at 07:57 AM
...
(1, 'Football', './sport_img/football.png', 'Association football, more commonly known as simply football or soccer, is a team sport played between two teams of 11 players who primarily use their feet to propel the ball around a rectangular field called a pitch.', 10, 2, 22),
(2, 'Basketball', './sport_img/basketball.png', 'Basketball is a team sport in which two teams, most commonly of five players each, opposing one another on a rectangular court, compete with the primary objective of shooting a basketball (approximately 9.4 inches (24 cm) in diameter) through the defender', 10, 1, 10),
...
--
ALTER TABLE `book`
  MODIFY `book_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `participate`
  MODIFY `participate_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
