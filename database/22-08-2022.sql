...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2022 at 12:41 AM
...
(6, 3, 0, 3, 'SPRINGWOOD', '2022-08-28-10:06', NULL),
(7, 1, 0, 3, 'SPRINGWOOD', '2022-08-28-10:06', NULL),
...
(1, 'Football', './sport_img/football.png', 'Association football, more commonly known as simply football or soccer, is a team sport played between two teams of 11 players who primarily use their feet to propel the ball around a rectangular field called a pitch.', 10, 1, 22),
...
(3, 'Tennis', './sport_img/tennis.png', 'Tennis is a racket sport that is played either individually against a single opponent or between two teams of two players each.', 10, 30, 4);
...
--
ALTER TABLE `book`
  MODIFY `book_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
