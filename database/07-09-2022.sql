...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 07, 2022 at 01:56 PM
...
(1, 1, 2, 3, 'SPRINGWOOD', '2022-08-28-10:06', 'nice'),
...
(38, 1, 3, 1, 'SPRINGFIELD LAKES', '2022-08-19T06:00', NULL),
(39, 1, 5, 1, 'SPRINGFIELD LAKES', '2022-09-17T11:33', NULL);
...
(10, 4, 1, 4, 'SPRINGWOOD', '2022-09-16T19:14'),
(11, 1, 5, 1, 'SPRINGFIELD LAKES', '2022-09-08T22:29'),
(12, 1, 5, 1, 'SPRINGFIELD LAKES', '2022-09-27T21:29'),
(13, 1, 0, 1, 'SPRINGFIELD LAKES', '2022-09-16T21:29'),
(14, 1, 0, 1, 'SPRINGFIELD LAKES', '2022-09-17T21:30');
...
(20, 1, 9, 'SPRINGFIELD LAKES', '2022-09-09T23:19'),
(21, 1, 9, 'SPRINGFIELD LAKES', '2022-09-16T00:19'),
(22, 1, 9, 'SPRINGFIELD LAKES', '2022-09-15T21:19'),
(23, 1, 4, 'SPRINGFIELD LAKES', '2022-09-16T23:21'),
(24, 1, 4, 'SPRINGFIELD LAKES', '2022-09-15T21:24'),
(25, 1, 6, 'SPRINGFIELD LAKES', '2022-09-18T21:22'),
(26, 1, 3, 'SPRINGFIELD LAKES', '2022-09-24T21:22'),
(27, 1, 2, 'SPRINGWOOD', '2022-09-09T21:22'),
(28, 1, 7, 'Earth', '2022-09-10T23:30');
...
(1, 'Football', './sport_img/football.png', 'Association football, more commonly known as simply football or soccer, is a team sport played between two teams of 11 players who primarily use their feet to propel the ball around a rectangular field called a pitch.', 10, 11, 22),
...
(1, 'nhwwnhww', '123', './user_img/Gundam pilots and clones summing up a world which is heavily divided into factions which break and urbanize by Andreas Rocha and Simon Stalenhag, trending on Artstation_1.jpeg.png', 'SPRINGFIELD LAKES', 'nhwenhww@gmail.com', 18, 404961471, 1),
(2, '123', '123', './user_img/Video_30_07_2022(1)_0081.png.png', 'SPRINGWOOD', 'gaoyixuan20@gmail.com', 14, 0, NULL),
(3, 'springfield', '123', './user_img/iphone_oryx.png.png', 'SPRINGFIELD LAKES', 'springfield@lol.com', 11, 404961471, NULL),
(4, 'julia', 'password', './user_img/women(4)_0.png.png', 'SPRINGFIELD LAKES', 'jpunj1@eq.edu.au', 18, 404961471, NULL),
...
(7, 'HackTec', 'HailHackTec', './user_img/man(3)_0.png.png', 'Earth', 'HackTec@Hack.com.jo', 500000, 999999999, NULL),
(8, 'tin', ':)', './user_img/IMG_1866.JPG.png', 'SPRINGFIELD LAKES', 'tin@tin.com', 2300, 404961471, NULL),
(9, '123', '123', './user_img/history.jfif.png', 'SPRINGFIELD LAKES', '123', 18, 404961471, NULL);
...
--
ALTER TABLE `book`
  MODIFY `book_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `game`
--
ALTER TABLE `game`
  MODIFY `game_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `participate`
  MODIFY `participate_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
