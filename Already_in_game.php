...
<?php 
    ...
    <script>
        ...
        function Redirect()
        {
        window.location="Find_game.php?user_id=<?php echo $user_id?>&sport_id=<?php echo $sport_id?>";
        }
    </script>
    
    <h1>
    Sorry, You already in this game
    <br>
    ...
    Still
        ...
        <br>
        <a href="Find_game.php?user_id=<?php echo $user_id?>&sport_id=<?php echo $sport_id?>" class="btn btn-primary">Back to find game page</a>
    </h1>
</body>
</html>